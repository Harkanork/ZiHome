...
echo "<CENTER><A HREF=\"./conso_elec.php?delai=heure\">Heure</A> , <A HREF=\"./conso_elec.php?delai=jour\">Jour</A></CENTER>";

include("./pages/conso_elec_phases_graph.php");

include("./pages/conso_elec_global.php");

include("./pages/conso_elec_global_month.php");
