...
{
echo "<TR><TD>".$data['nom']."</TD><TD ALIGN=CENTER>".$data0['direction']."</TD><TD ALIGN=CENTER>".$data0['vitesse']."</TD><TD ALIGN=CENTER>".$batterie."</TD></TR>";
}
}
echo "</TABLE></CENTER>";
...
while($data0 = mysql_fetch_assoc($req0))
{
$liste1 .= "[".strtotime($data0['date']) * 1000 . "," . $data0['direction'] ."],";
if(!($data0['vitesse'] == 0)) {
$liste2 .= "[".strtotime($data0['date']) * 1000 . "," . $data0['vitesse'] ."],";
}
}
