...
<CENTER>
<br>
<TABLE border=0><TR class="title" bgcolor="#6a6a6a"><TD>Id</TD><TD>Nom</TD><TD>Largeur</TD><TD>Hauteur</TD><TD>Droite</TD><TD>Bas</TD><TD>Afficher<br>nom</TD><TD>Taille-texte</TD><TD>Alignement</TD><TD>Bordure</TD><TD>suppl&eacute;mentaire</TD><TD>&nbsp;</TD><TD>&nbsp;</TD></TR>
<?
  ...
  while ($data = mysql_fetch_assoc($req))
  {
      ...
      echo '<FORM method="post" action="./index.php?page=administration&detail=gerer_pieces">';
