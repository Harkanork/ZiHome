...
<BR>Serveur Mysql : <INPUT type=text name=hote value="<? echo $_POST['hote']; ?>"></INPUT>
<BR>Base Mysql : <INPUT type=text name=base value="<? echo $_POST['base']; ?>"></INPUT>
<BR>Creer la base Mysql : <INPUT type=checkbox name=creer_base value=1 <? if($_POST['creer_base'] == '1') { echo " checked"; } ?>></INPUT>
<BR>Login Mysql : <INPUT type=text name=login value="<? echo $_POST['login']; ?>"></INPUT>
<BR>Mot de passe Mysql : <INPUT type=text name=plogin value="<? echo $_POST['plogin']; ?>"></INPUT>
<BR><BR>
<BR>Electricite Cout fixe : <INPUT type=text name=coutfixe value="<? echo $_POST['coutfixe']; ?>"></INPUT>
<BR>Electricite Cout Heure Pleine : <INPUT type=text name=HP value="<? echo $_POST['HP']; ?>"></INPUT>
<BR>Electricite Cout Heure Creuse : <INPUT type=text name=HC value="<? echo $_POST['HC']; ?>"></INPUT>
<BR>Electricite plage Heure Creuse 1 debut : <INPUT type=time name=heurescreusesdebut1 value="<? echo $_POST['heurescreusesdebut1']; ?>"></INPUT>
<BR>Electricite plage Heure Creuse 1 fin : <INPUT type=time name=heurescreusesfin1 value="<? echo $_POST['heurescreusesfin1']; ?>"></INPUT>
...
<BR>Adresse IP Serveur : <INPUT type=text name=ipserver value="<? echo $_POST['ipserver']; ?>"></INPUT>
<BR><BR>
...
?>
<P align=center><FORM method="post" action="./index.php">
<BR>Serveur Mysql : <INPUT type=text name=hote></INPUT>
<BR>Base Mysql : <INPUT type=text name=base></INPUT>
<BR>Creer la base Mysql : <INPUT type=checkbox name=creer_base value=1></INPUT> 
<BR>Login Mysql : <INPUT type=text name=login></INPUT>
<BR>Mot de passe Mysql : <INPUT type=text name=plogin></INPUT>
<BR><BR>
<BR>Electricite Cout fixe : <INPUT type=text name=coutfixe></INPUT>
<BR>Electricite Cout Heure Pleine : <INPUT type=text name=HP></INPUT>
<BR>Electricite Cout Heure Creuse : <INPUT type=text name=HC></INPUT>
<BR>Electricite plage Heure Creuse 1 debut : <INPUT type=time name=heurescreusesdebut1 value="00:00"></INPUT>
...
<BR>Adresse IP ZiBase : <INPUT type=text name=ipzibase></INPUT>
<BR>Adresse IP Serveur : <INPUT type=text name=ipserver></INPUT>
<BR><BR>
<INPUT type=submit name=valider value=Valider></INPUT>
</FORM></P>
<?
