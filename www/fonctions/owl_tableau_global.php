...
{
echo "<CENTER><TABLE>";
echo "<TR><TD>Phase 1 : </TD><TD>".$periph['chan1']." Watt/h</TD></TR>";
echo "<TR><TD>Phase 2 : </TD><TD>".$periph['chan2']." Watt/h</TD></TR>";
echo "<TR><TD>Phase 3 : </TD><TD>".$periph['chan3']." Watt/h</TD></TR>";
echo "<TR><TD>Total   : </TD><TD>".($periph['chan1'] + $periph['chan2'] + $periph['chan3'])." Watt/h</TD></TR>";
echo "</TABLE></CENTER>";
}
echo "</TD><TD>&nbsp;</TD><TD>";
...
while ($periph = mysql_fetch_assoc($req))
{
echo "<TR><TD>Aujourd'hui&nbsp;</TD><TD>".$periph['chan1']."</TD><TD>".$periph['chan2']."</TD><TD>".$periph['chan3']."</TD><TD>".$periph['total']."</TD><TD>".$periph['cout']." &euro;</TD></TR>";
}
...
while ($periph = mysql_fetch_assoc($req))
{
echo "<TR><TD>hier</TD><TD>".$periph['chan1']."</TD><TD>".$periph['chan2']."</TD><TD>".$periph['chan3']."</TD><TD>".$periph['total']."</TD><TD>".$periph['cout']." &euro;</TD></TR>";
}
...
while ($periph = mysql_fetch_assoc($req))
{
echo "<TR><TD>7 jours</TD><TD>".$periph['chan1']."</TD><TD>".$periph['chan2']."</TD><TD>".$periph['chan3']."</TD><TD>".$periph['total']."</TD><TD>".$periph['cout']." &euro;</TD></TR>";
}
...
while ($periph = mysql_fetch_assoc($req))
{
echo "<TR><TD>30 jours</TD><TD>".$periph['chan1']."</TD><TD>".$periph['chan2']."</TD><TD>".$periph['chan3']."</TD><TD>".$periph['total']."</TD><TD>".$periph['cout']." &euro;</TD></TR>";
}
...
while ($periph = mysql_fetch_assoc($req))
{
echo "<TR><TD>1 an</TD><TD>".$periph['chan1']."</TD><TD>".$periph['chan2']."</TD><TD>".$periph['chan3']."</TD><TD>".$periph['total']."</TD><TD>".$periph['cout']." &euro;</TD></TR>";
}
echo "</TABLE></CENTER>";
?>
